...
require("lz.n").load({
    {
        ...
        after = function()
            ...
            require("avante").setup({
                providers = { ollama = { endpoint = "http://localhost:11434", model = "qwen2.5-coder:32b" } },
            })
        end,
        ...
        { name = "pyright" },
        {
            extraOptions = {
                settings = {
                    nixd = {
                        formatting = {
                            command = { "/nix/store/glvjpnwkw85ssxxzrh0qc9am81h5pijq-nixfmt-1.0.0/bin/nixfmt" },
                        },
                        nixpkgs = {
                            expr = 'import (builtins.getFlake "/nix/store/lfagbayxzcjm94khi5mpmg44acvpzldc-source").inputs.nixpkgs { }',
                        },
                    },
                },
            },
